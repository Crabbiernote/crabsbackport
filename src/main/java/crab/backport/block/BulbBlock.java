    ...
    public void update(BlockState state, ServerWorld world, BlockPos pos) {
        ...
        if (bl != (Boolean) state.get(POWERED)) {
            ...
            if (!(Boolean) state.get(POWERED)) {
                ...
                world.playSound(null, pos, blockState.get(LIT) ? CrabsBackportSounds.BLOCK_COPPER_BULB_TURN_ON : CrabsBackportSounds.BLOCK_COPPER_BULB_TURN_OFF, SoundCategory.BLOCKS);
            }
